...
Пригласительный код создан: ${creatorFullName}`;
            ...
            case 'needName':
                ...
                const urgencyText = `<blockquote><b>🔥 Срочно</b>
Нужно сегодня / максимум завтра. 
Работа встанет, если не привезти</blockquote><blockquote><b>⏳ В ближайшее время</b>
Нужно в течение 1–3 дней. 
Можно планировать поставку</blockquote><blockquote><b>📅 Планово</b>
Нужно позже 3 дней. 
